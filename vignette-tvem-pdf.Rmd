...
[https://github.com/dziakj1/TvemPackage_development](https://github.com/dziakj1/TvemPackage_development),
and it can then be used with the `install.packages()` function in R code, 
 ...
 The package is also available at [https://github.com/dziakj1/tvem](https://github.com/dziakj1/tvem)
 for use with the `install_github` function.
